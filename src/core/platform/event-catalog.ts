...
export const EVENT_CATALOG = {
  ...
  ExecutionCompleted: entry("ExecutionCompleted", "trade.execution.completed", "BUSINESS", "trade"),
  ...
  WindowCompleted: entry("WindowCompleted", "decision.window.completed", "OPERATIONAL", "decision"),
